!function (t) {
  ...
  o.e = function (t) {
    ...
    if (0 !== r) if (r) n.push(r[2]); else {
      ...
      u.charset = "utf-8", u.timeout = 120, o.nc && u.setAttribute("nonce", o.nc), u.src = function (t) {
        return o.p + "bundle." + ({1: "util"}[t] || t) + ".js"
      }(t);
      var a = new Error;
      c = function (n) {
  ...
  var e, o, i, c = r(5), u = r(37), a = r(38), f = r(17), s = r(0), l = s.process, p = s.setImmediate,
      h = s.clearImmediate, v = s.MessageChannel, d = s.Dispatch, y = 0, m = {}, g = function () {
        var t = +this;
    ...
    var t, n = (t = regeneratorRuntime.mark((function t(n) {
      return regeneratorRuntime.wrap((function (t) {
        for (; ;) switch (t.prev = t.next) {
          case 0:
            return t.next = 2, r.e(1).then(r.bind(null, 49));
          case 2:
            (0, t.sent.sayHi)();
          case 5:
          case"end":
  ...
  "use strict";
  var e, o, i, c, u = r(12), a = r(0), f = r(5), s = r(8), l = r(24), p = r(4), h = r(6), v = r(29), d = r(30),
  ...
  M || (S = function (t) {
    v(this, S, "Promise", "_h"), h(t), e.call(this);
    try {
  ...
  var e = r(0), o = r(2), i = r(15), c = r(11), u = r(5), a = function (t, n, r) {
    ...
    for (f in v && (r = n), r) l = ((s = !h && g && void 0 !== g[f]) ? g : r)[f], p = m && s ? u(l, e) : y && "function" == typeof l ? u(Function.call, l) : l, g && c(g, f, l, t & a.U), w[f] != l && i(w, f, p), y && x[f] != l && (x[f] = l)
  };
  ...
  (n = t.exports = function (t, n, r, l, p) {
    ...
    if (i(m)) {
      for (h = u(t.length); h > w; w++) if ((y = n ? g(c(v = t[w])[0], v[1]) : g(t[w])) === f || y === s) return y
  ...
  t.exports = function () {
    ...
    if (a) r = function () {
      ...
      new i(f).observe(p, {characterData: !0}), r = function () {
        p.data = l = !l
      }
    }
    return function (e) {
